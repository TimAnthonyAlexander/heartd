...
func (db *DB) DeleteNodeData(name string) error {
	for _, table := range []string{"metric_sample", "check_status", "disk_status", "disk_usage_sample", "net_sample", "cpu_state_sample", "process_top", "cpu_core", "net_interface", "raid_array", "smart_disk"} {
